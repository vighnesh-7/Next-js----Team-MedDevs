    ...
    return (
        <footer  className='relative bg-emerald-800 w-full bottom-0 left-0 before:absolute before:top-0 before:left-0' >
        <div className="content " style={{
            ...
            <div className="logo-details flex-between text-slate-50 " >
                <Image src="/public/assets/icons/logo.svg" width='50' height={'50'} className='mr-2' />
                <span className="text-3xl font-semibold " style={{fontWeight:'600'}} >NAME</span>
            </div>
            ...
            <ul className="box" style={{  width: ' calc(100% / 5 - 10px)'}}>
                ...
                <li className="link_name relative text-slate-50 font-semibold mb-1  text-lg">Service</li>
                </div>
                ...
                <li><a href="/" className='text-base hover:underline hover:underline-offset-4 text-gray-300 font-medium' style={{transition:'all 0.5s ease'}}>Careers</a></li>
        ...
        <div className="bottom-details w-full py-2 px-4 bg-zinc-600">
            <div className="bottom_text m-auto flex-between">
                <span className="copyright_text opacity-80 text-slate-50 hover:opacity-100 ">Copyright © 2024 by MedDevs
                <a className='opacity-90 text-slate-50  hover:underline px-4 hover:opacity-100'  href="/">NAME</a>
                All rights reserved
            </span>
